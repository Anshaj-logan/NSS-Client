  ...
  return (
    ...
    <section style={{ backgroundColor: "#eee" }}>
      ...
      <form className="form-horizontal">
        ...
        <div className="form-group row">
          <label className="control-label col-md-3">Passout year</label>
          <div className="col-md-8">
            <input
              className="form-control"
              type="text"
        ...
        <div className="row">
          <div className="col-md-8 col-md-offset-3">
            ...
            &nbsp;&nbsp;&nbsp;
            <Link to={'/aluprofile'}><a className="btn btn-secondary" href="">
...
export default AlupdateProfile