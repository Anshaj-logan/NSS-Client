          ...
          <div className="col-lg-8">
            <div className="card mb-4">
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-sm-3">
                    <p className="mb-0">Passout year</p>
                  </div>
                  <div className="col-sm-9">
                    <p className="text-muted mb-0">
                      2023
                ...
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0">kalluvalapil house</p>
                  </div>
                </div>
                {/* <hr /> */}
                {/* <div className="row">
  ...
  <div className="tile-footer">
    <div className="row">
      <div className="col-md-8 col-md-offset-3">
       <Link to={'/alupdateprofile'}> <a href="">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <Link to={'/alumni'}><a className="btn btn-secondary" href="">
