...
const RegVo = () => {
  ...
  const validate = (values)=>{
    ...
    // }
    if(!values.activity){
      error.activity ="Enter Activity"
    }
    if(!values.course){
      error.course ="Enter Course"
    }
    if(!values.semester){
      error.semester ="Enter Current semester"
    }
      ...
      <div className="card-body py-5 px-md-5">
        <div className="row d-flex justify-content-center">
          <div className="col-lg-8">
            <h2 className="fw-bold mb-5">Register as Volunteer</h2>
            <ToastContainer />
...
{/*                     
        ...
        onClick={()=>{setformErrors({...formErrors,course:""})}}
                ...
                <div className="col-md-6 mb-4">
                  <div className="form-outline">
                  <span style={{color:"red"}} > {formErrors.semester? formErrors.semester :""}</span>
        <input
        name="semester"
        value={inputs.semester || ""}
        onChange={setRegister} 
        onClick={()=>{setformErrors({...formErrors,semester:""})}}
                      type="text"
                      id="form3Example2"
                      className="form-control"
                    />
