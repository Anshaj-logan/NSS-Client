...
const RegCo = () => {
  ...
  const validate = (values)=>{
    ...
    if(!values.acadamic_year){
      error.acadamic_year ="Enter Acadamic Year"
    }
    if(!values.cnf_password){
      error.cnf_password ="Enter Password"
    }
      ...
      <div className="card-body py-5 px-md-5">
        <div className="row d-flex justify-content-center">
          <div className="col-lg-8">
            <h2 className="fw-bold mb-5">Register as Coordinator</h2>
            <ToastContainer />
  <form onSubmit={registerSubmit}>
        ...
        onClick={()=>{setformErrors({...formErrors,username:""})}}
              ...
              <div className="row">
                <div className="col-md-6 mb-4">
                  <div className="form-outline">
                  <span style={{color:"red"}} > {formErrors.about? formErrors.about :""}</span>
        <input
        name="about"
        value={inputs.about || ""}
        onChange={setRegister} 
        onClick={()=>{setformErrors({...formErrors,about:""})}}
                      type="text"
                      id="form3Example1"
                      className="form-control"
                    />
                ...
                <div className="col-md-6 mb-4">
                  <div className="form-outline">
                  <span style={{color:"red"}} > {formErrors.designation? formErrors.designation :""}</span>
        <input
        name="designation"
        value={inputs.designation || ""}
        onChange={setRegister} 
        onClick={()=>{setformErrors({...formErrors,designation:""})}}
                      type="text"
                      id="form3Example2"
                      className="form-control"
                    />
        ...
        onClick={()=>{setformErrors({...formErrors,department:""})}}
                ...
                <div className="col-md-6 mb-4">
                  <div className="form-outline">
                  <span style={{color:"red"}} > {formErrors.acadamic_year? formErrors.acadamic_year :""}</span>
        <input
        name="acadamic_year"
        value={inputs.acadamic_year || ""}
        onChange={setRegister} 
        onClick={()=>{setformErrors({...formErrors,acadamic_year:""})}}
                      type="text"
                      id="form3Example2"
                      className="form-control"
                    />
